...
#
# timing_proj.tcl: Tcl script for re-creating project 'timing_proj'
#
# Generated by Vivado on Wed May 04 14:41:27 CEST 2022
...
#
# 1. This project restoration tcl script (timing_proj.tcl) that was generated.
#
...
#
#    "/home/chao/Desktop/VHDL-timing-experiment/source/sigmoid.vhd"
#    "/home/chao/Desktop/VHDL-timing-experiment/source/top.vhd"
#    "/home/chao/Desktop/VHDL-timing-experiment/constraints/power_estimation.xdc"
#
#*****************************************************************************************
...
set _xil_proj_name_ "timing_proj"
...
set script_file "timing_proj.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/timing_proj"]"

# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xc7s15ftgb196-2
...
set_property -name "part" -value "xc7s15ftgb196-2" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/source/sigmoid.vhd"] \
 [file normalize "${origin_dir}/source/top.vhd"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/source/sigmoid.vhd"
...
set file "[file normalize "$origin_dir/constraints/power_estimation.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constraints/power_estimation.xdc"
set file [file normalize $file]
...
set_property -name "target_part" -value "xc7s15ftgb196-2" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7s15ftgb196-2 -flow {Vivado Synthesis 2019} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7s15ftgb196-2 -flow {Vivado Implementation 2019} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
